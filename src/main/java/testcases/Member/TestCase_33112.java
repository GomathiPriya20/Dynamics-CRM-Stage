...
//TFS ID_33112 : Verify for Child accounts whose "Exclude from Roster" can be Yes when the parent has "Exclude from Roster" as Yes.
public class TestCase_33112 {
	...
	public void verifyExcludeFromRosterYes(int iRowNumber, String sDataSheetName) throws Exception, InterruptedException 
	{
		...
		//Verify 'Exclude From Roster' Default Value =No
		...
		.selectExcludeFromRoster(DataInputProvider.getCellData_ColName(iRowNumber, "ExcludeFromRoster1", sDataSheetName))
