...
//TFS ID_ 44713:Verify a member record can be created and published by a Member - Positive case

public class TestCase_44713 {
	...
	public void createMemberTP(int iRowNumber, String sDataSheetName) throws Exception, InterruptedException  {
		...
		//Verify Affiliate Aggregation and Naitional
		
		.verifyMembership("Aggregation Affiliation")
		.verifyMembership("National")
		
		//Verify Account number Enity code
		.navigateToGeneralTab()
		
		.selectAccountNumbers()
		.verifyAccountNumberEntityCode()
