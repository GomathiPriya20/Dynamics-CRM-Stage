...
public class TestCase_44008 {
	...
	public void verifyLocationType(int iRowNumber, String sDataSheetName) throws Exception {
		...
		.verifyDirectParentList(DataInputProvider.getCellData_ColName(iRowNumber, "directParent", sDataSheetName), false)
