...
public class TestCase_43982 {
	...
	public void verifyLocationType(int iRowNumber, String sDataSheetName) throws Exception {
		...
		.selectDiversityInformationEntity()
		.addDiversityInformation(DataInputProvider.getCellData_ColName(iRowNumber, "DiversityValue", sDataSheetName),DataInputProvider.getCellData_ColName(iRowNumber, "CertifyingAgency", sDataSheetName))
