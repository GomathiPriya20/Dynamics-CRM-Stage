...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	...
	public void selectDropDownUsingVisibleText(WebElement ele, String value) {
		try {
			...
			setReport().log(Status.PASS, "The data: "+value+" successfully selected in : "+ele);
	...
	public void verifyExactText(WebElement ele, String expectedText) {
		...
		try {
			if(bReturn.equalsIgnoreCase(expectedText)) {
				setReport().log(Status.PASS, "The text :"+bReturn+" matches with the value :"+expectedText,screenshotCapture());
			}else {
				setReport().log(Status.FAIL, "The text :"+bReturn+" did not match with the value :"+expectedText,screenshotCapture());
			}
		} catch (WebDriverException e) {
